...
def get_all_comparison(preprocessing:bool=True,good_gene_associations:bool=True,disp_scatterplot:bool=True,stats:bool=True): 
    pp = {
        "name":[],
    ...
    for path in os.listdir("../data/tests/test_data/input/") : 
        ...
        enrichment_tot = gp.tl.GREAT.enrichment(test_file=test,
                                                    regdom_file=regdom,
                                                    chr_size_file=size,
